...
type=unsupervised-model
dataset_name=processed_unsupervised_model_data
data_dir=data/processed_unsupervised_model_data
...
#python3 code2seq.py --data ${data} --predict
